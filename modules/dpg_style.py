...
def create_styles():
    ...
    with dpg.theme(tag="derivative2nd_theme"):
        with dpg.theme_component(dpg.mvAll):
            ...
            dpg.add_theme_color(dpg.mvPlotCol_Line, (48,70,116), category=dpg.mvThemeCat_Plots)
    ...
    with dpg.theme(tag = "fitting_MBG_theme"):
        with dpg.theme_component(dpg.mvAll):
            dpg.add_theme_style(dpg.mvPlotStyleVar_LineWeight, 2, category=dpg.mvThemeCat_Plots)
            dpg.add_theme_color(dpg.mvPlotCol_Line, (216, 82, 75), category=dpg.mvThemeCat_Plots)
